...
.alert-box{background:#fffbe6;border-left:3px solid #b88a00;border-radius:0 10px 10px 0;padding:12px 16px;margin-top:12px;font-size:14px;color:#5a4200;line-height:1.7}
.alert-box strong{color:#3a2a00;font-size:16px}
    ...
    <div class="faq-list" id="faq">
      ...
      <div class="faq-item" data-idx="5">
        ...
        <div class="faq-body" id="body-5">
          ...
          <div class="alert-box"><strong>Ramal *1000</strong> — canal oficial de suporte durante a virada de sistema.</div>
        </div>
      </div>
